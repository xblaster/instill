...
describe('fetch module', () => {
    ...
    describe('convertGitHubUrlToRawUrl', () => {
        it('converts GitHub URL to raw content URL', () => {
            ...
            expect(result).toBe('https://raw.githubusercontent.com/user/repo/main/skills/test.md');
        });
        ...
        it('accepts custom branch', () => {
            ...
            expect(result).toBe('https://raw.githubusercontent.com/user/repo/develop/skills/test.md');
        });
    ...
    describe('fetchSkillFromRemote', () => {
        ...
        it('fetches skill content from remote', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith('https://raw.githubusercontent.com/user/repo/main/skills/test-skill.md', expect.objectContaining({
                method: 'GET',
        ...
        it('rejects non-github source types', async () => {
            ...
            await expect(fetchSkillFromRemote(invalidSource, 'test')).rejects.toThrow(/Unsupported source type/);
        });
    });
});
