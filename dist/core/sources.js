 ...
 */
export async function loadRemoteSources() {
 ...
 */
export async function addRemoteSource(url, name) {
    // Validate GitHub URL
    if (!isValidGitHubUrl(url)) {
        throw new Error(`Invalid repository URL: "${url}". Must be a GitHub HTTPS URL (e.g., https://github.com/user/repo)`);
    }
 ...
 */
export async function removeRemoteSource(name) {
    const sources = await loadRemoteSources();
 ...
 */
export async function listRemoteSources() {
