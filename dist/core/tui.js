 ...
 */
export async function selectSkills(available, installed) {
 ...
 */
export async function selectTargets(active) {
    const targets = [
 ...
 */
export async function manageRemoteSources() {
 ...
 */
export async function promptForSourceName(suggestedName) {
 ...
 */
export async function selectSourceToRemove(sources) {
    if (sources.length === 0) {
